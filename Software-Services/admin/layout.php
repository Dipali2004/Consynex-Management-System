  ...
  <?php else: ?>
    <div class="app">
      <aside class="sidebar" id="sidebar">
        <a class="brand" href="/Software-Services/admin/dashboard.php"><i
            class="fa-solid fa-graduation-cap"></i><span>Training Admin</span></a>
        <div class="nav-section">
          <a class="nav-link <?php echo ($title ?? '') === 'Dashboard' ? 'active' : ''; ?>"
            href="/Software-Services/admin/dashboard.php"><i class="fa-solid fa-house"></i><span>Dashboard</span></a>
          <a class="nav-link" href="/Software-Services/admin/banners.php"><i class="fa-regular fa-image"></i><span>Manage
              Banners</span></a>
          <a class="nav-link" href="/Software-Services/admin/courses.php"><i class="fa-solid fa-book"></i><span>Manage
              Courses</span></a>
          <a class="nav-link" href="/Software-Services/admin/trainings.php"><i
              class="fa-solid fa-layer-group"></i><span>Manage Trainings</span></a>
          <a class="nav-link <?php echo ($title ?? '') === 'Services' ? 'active' : ''; ?>"
            href="/Software-Services/admin/services.php"><i class="fa-solid fa-server"></i><span>Manage
              Services</span></a>
          <a class="nav-link" href="/Software-Services/admin/pages.php"><i
              class="fa-regular fa-file-lines"></i><span>Manage Pages</span></a>
          <a class="nav-link" href="/Software-Services/admin/gallery.php"><i class="fa-solid fa-images"></i><span>Manage
              Gallery</span></a>
          <a class="nav-link" href="/Software-Services/admin/enquiries.php"><i
              class="fa-regular fa-message"></i><span>Manage Enquiries</span></a>
          <a class="nav-link" href="/Software-Services/admin/pages.php"><i
              class="fa-solid fa-gear"></i><span>Settings</span></a>
          <a class="nav-link <?php echo ($title ?? '') === 'Manage Admin Users' ? 'active' : ''; ?>"
            href="/Software-Services/admin/admin_users.php"><i class="fa-solid fa-user-shield"></i><span>Manage
              Admins</span></a>
        </div>
        <div class="mt-auto p-3">
          <a class="nav-link" href="/Software-Services/admin/logout.php"><i
              class="fa-solid fa-right-from-brackets"></i><span>Logout</span></a>
        </div>
      </aside>
      <div class="content">
        <div class="topbar">
