...
try {
    ...
    $stmt->execute(['Digital Marketing']);
    $digital_services = $stmt->fetchAll();
} catch (Exception $e) {
  ...
  <div class="container">
    <div class="row justify-content-center text-center mb-5">
      <div class="col-lg-8 col-md-12">
        <div class="theme-title">
          ...
          <p>We provide a complete suite of digital marketing services designed to elevate your brand and drive measurable results.</p>
        </div>
      </div>
    </div>
    ...
    <?php if (empty($digital_services)): ?>
        <div class="text-center py-5">
            <p class="text-muted">No digital marketing services are available at the moment. Please check back later.</p>
        </div>
    <?php else: ?>
        <div class="row gx-lg-5 text-center justify-content-center">
            <?php foreach ($digital_services as $srv): ?>
            <div class="col-lg-4 col-md-6 mb-5">
                <div class="service-item style-1 h-100 d-flex flex-column">
                    <div class="service-images mb-4 d-flex align-items-center justify-content-center" style="min-height: 80px;">
                        ...
                        <?php else: ?>
                            <i class="bi bi-bullseye" style="font-size: 3.5rem; color: #2563eb;"></i>
                        <?php endif; ?>
                    </div>
