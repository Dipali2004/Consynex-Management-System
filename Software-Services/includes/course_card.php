...
<div class="col-lg-4 col-md-6 mb-5">
    <div class="service-item style-1 h-100 d-flex flex-column">
        ...
        <div class="service-desc flex-grow-1 d-flex flex-column" style="padding-top: 10px;">
            ...
            <div class="mt-auto">
                <a class="btn btn-outline-primary btn-sm rounded-pill px-4" href="/training/course/<?php echo htmlspecialchars($c['slug']); ?>">
                    View Course <i class="bi bi-arrow-right-short"></i>
                </a>
                <?php if (empty($hideEnquiryButton)): ?>
                <button class="btn btn-outline-primary btn-sm rounded-pill px-4 ms-2" onclick='openInquiryForm(<?php echo json_encode($courseName); ?>)'>
