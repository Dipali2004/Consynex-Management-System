...
<section class="hero-consynex d-flex align-items-center">
    ...
    <div class="row">
      <div class="col-lg-10 col-xl-8">
        <h1 class="display-4 fw-bold text-white mb-3 animate__animated animate__fadeInUp"
          style="color: #ffffff !important;">CONSYNEX TECHNOLOGIES</h1>
        <h2 class="h4 text-white-50 mb-4 animate__animated animate__fadeInUp animate__delay-1s">Industry-Oriented IT
          Training & Career Development Institute</h2>
        <p class="text-white-50 mb-4 animate__animated animate__fadeInUp animate__delay-2s">At Consynex Technologies, we
          provide practical, job-focused IT training with real-time projects, expert mentors, and industry-relevant
          courses. Our goal is to prepare students for successful careers in the IT industry.</p>
  ...
  <style>
    ...
    .hero-consynex .overlay {
      position: absolute;
      inset: 0;
      background: linear-gradient(180deg, rgba(6, 10, 15, .75), rgba(6, 10, 15, .55))
    }

    .hero-consynex .themeht-btn {
      border-radius: .6rem;
      transition: transform .15s ease, box-shadow .15s ease
    }

    .hero-consynex .cta-primary {
      background: #2563eb;
      border-color: #2563eb;
      color: #fff
    }

    .hero-consynex .cta-secondary {
      border-color: #93c5fd;
      color: #fff
    }

    .hero-consynex .themeht-btn:hover {
      ...
      <div class="row justify-content-center text-center">
        <div class="col-lg-8 col-md-12">
          <div class="theme-title">
            ...
            <p>Explore our industry-standard courses designed to boost your career. Learn from experts and work on
    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 col-md-12 mt-6 mt-lg-0 ps-lg-10">
          ...
          <p class="mb-5">Scale your software operations through a custom engineering team. Meet the demand of your
            company’s operations with a high-performing nearshore team skilled in the technologies you need.</p>
          ...
          <div class="row">
              ...
              <div class="testimonial style-1">
                <div class="testimonial-media">
                  <div class="testimonial-img">
                    <img class="img-fluid" src="images/testimonial/student1.jpeg" alt="">
                  </div>
                  <div class="testimonial-quote">
                    <i class="flaticon flaticon-quote"></i>
                  </div>
                </div>
                <p>Excellent training with clear explanations and practical examples. The concepts were taught in a very
                  simple way, which helped me gain confidence in IT fundamentals and real-world applications.</p>
            ...
            <div class="col-md-6 mt-10 mt-md-0">
              <div class="testimonial style-1">
                <div class="testimonial-media">
                  <div class="testimonial-img">
                    <img class="img-fluid" src="images/testimonial/student3.jpeg" alt="">
                  </div>
                  <div class="testimonial-quote">
                    <i class="flaticon flaticon-quote"></i>
                  </div>
                </div>
                <p>The teaching quality is very good and industry-oriented. Doubts are cleared patiently, and hands-on
                  practice made learning easy and effective. Highly recommended for beginners.</p>
                <div class="testimonial-caption">
                  <h5>Vijay Kamble</h5>
                  <label>Student</label>
                </div>
          ...
          <div class="row">
            <div class="col-md-6 mt-10">
              <div class="testimonial style-1">
                <div class="testimonial-media">
                  <div class="testimonial-img">
                    <img class="img-fluid" src="images/testimonial/student4.jpeg" alt="">
                  </div>
                  <div class="testimonial-quote">
                    <i class="flaticon flaticon-quote"></i>
                  </div>
                </div>
                <p>One of the best learning experiences. The training focuses on both theory and practical knowledge.
                  The guidance and support throughout the course were really helpful.</p>
                <div class="testimonial-caption">
                  <h5>Rupesh Gadhve</h5>
                  <label>Student</label>
                </div>
            ...
            <div class="col-md-6 mt-10 mt-md-0">
              <div class="testimonial style-1">
                <div class="testimonial-media">
                  <div class="testimonial-img">
                    <img class="img-fluid" src="images/testimonial/student2.jpeg" alt="">
                  </div>
                  <div class="testimonial-quote">
                    <i class="flaticon flaticon-quote"></i>
                  </div>
                </div>
                <p>Very well-structured training with real-time examples. The environment is friendly, and the trainer
                  explains each topic in detail. This course helped me build a strong foundation.</p>
                <div class="testimonial-caption">
                  <h5>Aryan Kadam</h5>
                  <label>Student</label>
                </div>
