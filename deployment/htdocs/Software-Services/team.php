    ...
    <div class="row justify-content-center text-center">
      <div class="col-lg-8 col-md-12">
        <div class="theme-title">
          <h6>Team Expert</h6>
          <h2>Meet Our Expert team member will ready for your service</h2>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-lg-4 col-md-6">
        <div class="team-member">
          <div class="team-images">
            <img class="img-fluid rounded" src="images/team/01.png" alt="">
          ...
          <div class="team-desc">
            <h5><a href="team-single.html">Rushikesh karande</a></h5>
      ...
      <div class="col-lg-4 col-md-6 mt-7 mt-md-0">
        <div class="team-member">
          <div class="team-images">
            <img class="img-fluid rounded" src="images/team/02.png" alt="">
            <div class="social-icons team-social-icon">
              <ul>
                <li>
                  <a href="#">
          ...
          <div class="team-desc">
            <h5><a href="team-single.html">Dnyaneshwar Londhe </a></h5>
            <span>FOUNDER & CEO</span>
          </div>
        </div>
      </div>
      <div class="col-lg-4 col-md-6 mt-7 mt-lg-0">
        <div class="team-member">
          <div class="team-images">
            <img class="img-fluid rounded" src="images/team/03.png" alt="">
            <div class="social-icons team-social-icon">
              <ul>
                <li>
                  <a href="#">
          ...
          <div class="team-desc">
            <h5><a href="team-single.html">Komal Bhatekar</a></h5>
            <!-- <span>Designer</span> -->
          </div>
        </div>
      </div>
